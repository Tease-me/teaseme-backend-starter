...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_mod_keywords_active'), table_name='moderation_keywords')
    op.drop_index(op.f('ix_mod_keywords_category'), table_name='moderation_keywords')
    op.drop_table('moderation_keywords')
    op.alter_column('content_violations', 'reviewed',
               existing_type=sa.BOOLEAN(),
               nullable=False,
               existing_server_default=sa.text('false'))
    op.drop_index(op.f('ix_infl_wallet_user_infl'), table_name='influencer_wallets')
    op.drop_constraint(op.f('uq_user_influencer_wallet'), 'influencer_wallets', type_='unique')
